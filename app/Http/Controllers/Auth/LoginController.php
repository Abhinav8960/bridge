...
class LoginController extends Controller
{
    ...
    */
    ...
    public function showLoginWithotpForm()
    {
        ...
        $mobileResult = $agent->isMobile();
        if ($mobileResult) {
            return view('auth.mobile.loginOtp');
        }
     ...
     * @return bool
     */
    protected function attemptOtpLogin(Request $request)
    {
        $user = Student::where('phone',$request->phone)->where('otp',$request->otp)->first();
     ...
     * @return array
     */
    protected function otpcredentials(Request $request)
    {
    ...
    // public function loginAsStudent($user){
    //     if(session()->has('isStudent') && session()->has('student') && session()->get('isStudent') == true){
    ...
    public function loginWithotp(Request $request)
    {
        ...
        if ($this->attemptOtpLogin($request)) {
            if ($request->hasSession()) {
                $request->session()->put('auth.password_confirmed_at', time());
            }
