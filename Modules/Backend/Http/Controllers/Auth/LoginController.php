...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        $this->middleware('guest')->except(['logout', 'loginAsAdmin']);
    }
    ...
    public function login(Request $request)
    {
        ...
        $useradmin = User::where('status', true)->where('phone', $request->phone)->first();
        if ($useradmin) {
            ...
            if ($this->attemptLogin($request)) {
                if ($request->hasSession()) {
                    ...
                    if($useradmin->role_id == User::ROLE_VENDOR){
        ...
        return Redirect::back()->withErrors(
            [
                'phone' => 'Your Login Is Suspended! Please Contact The Administrator.'
            ]
        );
    }
