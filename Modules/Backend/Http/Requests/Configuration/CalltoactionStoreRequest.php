...
class CalltoactionStoreRequest extends FormRequest
{
    /**
    ...
    {
        // dd(request()->call_to_action_type);
        $rule = [];

        $rule["call_to_action_type"] = "required|integer";
        // if(request()->call_to_action_type==1){
        //     $rule["specify_value"] = "required|email|unique:call_to_actions,specify_value";
        // }else{
