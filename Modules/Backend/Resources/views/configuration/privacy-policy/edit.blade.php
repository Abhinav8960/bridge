...
@section('content')
    ...
    <div class="main-content app-content">
        ...
        <div class="main-container container-fluid">
            ...
            <!-- /breadcrumb -->
            <div class="col-md-12 col-lg-12">
                <form action="{{ route('configuration.privacypolicy.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    @include('backend::configuration.privacy-policy._form')
                </form>
            </div>
        </div>
    </div>
