...
@section('content')
    <div class="main-content app-content">
        <div class="main-container container-fluid">
            ...
            <div class="col-md-12 col-lg-12">
                <div class="breadcrumb-header justify-content-between" style="padding-inline:12px;">
                    <div class="left-content">
                        <span class="main-content-title mg-b-0 mg-b-lg-1">Exam Stream</span>
                    </div>
            ...
            <!-- /breadcrumb -->
            <div class="col-md-12 col-lg-12">
                <form action="{{ route('configuration.stream.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    @livewire('backend::exam.stream.form', ['model' => $model])
                </form>
            </div>
        </div>
    </div>
