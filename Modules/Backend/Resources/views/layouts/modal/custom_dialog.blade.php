<form id="publishItemId" method="get" enctype="multipart/form-data">
    @csrf
    @method('GET')
    <div class="modal fade" id="publishItemModal" tabindex="-1" aria-labelledby="publishItemModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo"
                ...
                <div class="modal-body" style="margin-top: 50px; text-align: center; font-size: larger;">
                    <p style="margin: 0px">Are You Sure You Want To <span id="itemstatus"></span>:</p>
                    <b><p id="item"></p></b>
                </div>
