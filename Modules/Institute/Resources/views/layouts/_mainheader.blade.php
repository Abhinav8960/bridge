        ...
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="index.html" class="header-logo">
                    <img src="/assets/img/faces/Logo.png" class="mobile-logo logo-1" style="height:3rem;" alt="logo">
                    <img src="/assets/img/faces/Logo.png" class="mobile-logo dark-logo-1" style="height:3rem;"
                        alt="logo">
                </a>
            </div>
            ...
            <div class="logo-horizontal">
                <a href="index.html" class="header-logo">
                    <img src="/assets/img/faces/Logo.png" class="mobile-logo logo-1" alt="logo">
                    <img src="/assets/img/faces/Logo.png" class="mobile-logo dark-logo-1" alt="logo">
                </a>
            </div>
            <div class="main-header-center ms-4 d-sm-none d-md-none d-lg-block form-group">
                @livewire('institute::header.institute-info')
            </div>
        </div>
                    ...
                    <ul class="nav nav-item header-icons navbar-nav-right ms-auto">
                        ...
                        <li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
                            <a class="new nav-link profile-user d-flex" href="" data-bs-toggle="dropdown"><img
                                    alt="" src="/assets/img/faces/profile-avatar.jpg" class=""></a>
                            <div class="dropdown-menu">
                                <div class="menu-header-content p-3 border-bottom">
                                    <div class="d-flex wd-100p">
                                        <div class="main-img-user"><img alt=""
                                                src="/assets/img/faces/profile-avatar.jpg" class=""></div>
                                ...
                                <a class="dropdown-item" href="#"><i class="far fa-sun"></i>
                                    Settings</a>
