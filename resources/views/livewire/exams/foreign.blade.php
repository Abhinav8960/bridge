<div>
    ...
    <section class="exams-card mt-5">
        <div class="container">
            ...
            <div id="foreign-silder" class="cards slider-cards d-flex align-items-center mt-4">
            ...
            <div class="result-institutes mt-5">
                <div class="d-flex align-items-center mb-5">
                    <h2>Result:</h2>&nbsp;
                    <p><span> {{ $this->countInstituteStreamWise($selectedStream) }} institutes

                        </span> | @if (!empty($exams) && $exams->count() > 0)
                            {{ $exams->count() }} Exams
                        @else
                            0 Exam
                        @endif
