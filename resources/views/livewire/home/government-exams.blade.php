                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div id="government-silder" class="cards slider-cards mt-4 d-flex">
                            ...
                            @endif --}}
                                    <div class="text-center mt-3">
                                        <a class="viewall" href="{{ route('exams.government-exam') }}">View More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section--exams__card">
                            <div class="section--exams__card__header text-center">
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    ...
                                    @else
                                        <img src="assets/img/homepage/government-img.png" alt="">
                                    @endif
                                    {{-- <img src="assets/img/homepage/government-img.png" alt=""> --}}
                            ...
                            <div class="row ">
                                                    ...
                                                    <div class="card--box__img">
                                                        @if (!empty($stream->icon))
                                                            <img src="{{ Storage::disk('public')->url($stream->icon) }}"
                                                                alt="" class="img-1">
                                                        @else
                                                            <img src="assets/img/homepage/Banking.png" alt=""
                                                                class="img-2">
                                                        @endif
                                                    </div>
                                ...
                                <div class="text-center btn-wrapper">
                                    <a href="{{ route('exams.government-exam') }}">View More</a>
                                </div>
                            </div>
                            <div class="bottom-img">
                                @if (!empty($category->mobile_dashboard_banner))
                                    <img src="{{ Storage::disk('public')->url($category->mobile_dashboard_banner) }}"
                                        alt="" class="w-100">
                                @else
                                    <img src="assets/img/homepage/government-artwork.png" alt="" class="w-100">
                                @endif
                            </div>
                        </div>
                    </div>
