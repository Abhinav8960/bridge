                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div id="foreign-silder" class="cards slider-cards mt-4 d-flex">
                                        ...
                                        <a wire:click="showExams({{ $stream->id }})">
                                            <div class="card @if ($selectedStream == $stream->id) active @endif">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="">
                                                        <h3>{{ $stream->name }}</h3>
                                                        <p>{{ $this->countInstituteStreamWise($stream->id) }} Institutes
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            @foreach ($exams as $exam)
                                                <li>
                                                    <div class="card text-center mb-5" title="{{ strtoupper($exam->fullname) }}">
                                                        ...
                                                        <div class="card-body">
                                                            <a href="{{ route('explore.institute', [
                    ...
                    <div class="section--exams__card">
                        <div class="section--exams__card__header text-center">
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                {{-- <img src="assets/img/homepage/Foreign-img.png" alt=""> --}}
                                @if (!empty($category->icon))
                        ...
                        <div class="row ">
                                                ...
                                                <div class="card--box__img">
                                                    @if (!empty($stream->icon))
                                                        <img src="{{ Storage::disk('public')->url($stream->icon) }}"
                                                            alt="" class="img-1">
                                                    @else
                                                        <img src="assets/img/homepage/English-a.png" alt=""
                                                            class="img-2">
                                                    @endif
                                                </div>
                            ...
                            <div class="text-center btn-wrapper">
                                <a href="{{ route('exams.foreign-exam') }}">View More</a>
                            </div>
                        </div>
                        <div class="bottom-img">
                            @if (!empty($category->mobile_dashboard_banner))
                                <img src="{{ Storage::disk('public')->url($category->mobile_dashboard_banner) }}"
                                    alt="" class="w-100">
                            @else
                                <img src="assets/img/homepage/foreign-artwork.png" alt="" class="w-100">
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <script>
            document.addEventListener('livewire:load', function(event) {
                Livewire.hook('message.processed', () => {
                    foreignsliderActivate();
                });
            });

            function foreignsliderActivate() {
                $("#foreign-silder")
