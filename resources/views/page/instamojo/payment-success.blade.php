        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Payment Success Page</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="payment-success__content">
                        <div class="payment-success__content__heading">
                            <img src="/assets/skoodos/assets/img/Payment-Success.png" alt="">
                        </div>
                        <div class="payment-success__content__text">
                            ...
                            <div class="btn-wrapper d-flex justify-content-center">
                                <a href="{{ route('homepage') }}" class="btn blue-btn">Back To Home Page</a>
                            </div>
                        </div>
                    </div>
                </div>
