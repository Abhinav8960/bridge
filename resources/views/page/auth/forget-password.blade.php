...
<head>
  ...
  <meta property="og:title" content="Skoodos Bridge Forget Password" />
...
<body>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a class="nav-link " href="#"><span>Exams</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a  href="entrance_exam.html">Entrance Exams</a></li>
              <li><a href="government_exam.html">Government Exams</a></li>
              <li><a href="foreign_language.html">Foreign Language Exams</a></li>
            </ul>
          </li>
  ...
  <main id="main">
    ...
    <section class="login forget_password">
      <div class="container">
        <div class="login-page forget-pass-contain mt-5 mb-5">
          <div class="login-left-box d-flex">
            <div class="login-left">
              <div class="inner_center">
                <h3>Forget <span>Password?</span></h3>
                <p>Please Enter Your Mobile Number</p>
                <form method="get" class="login_form digit-group" data-group-name="digits" data-autosubmit="false"
                  autocomplete="off">
                  ...
                  <div class="login_buttons d-flex align-items-center justify-content-between">
                    <a type="submit" class="yellow-btn">Send</a>
                    <div class="d-flex login_register_btn">
